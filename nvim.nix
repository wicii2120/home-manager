...
in
{
  ...
  #
  # These live in home.packages rather than programs.neovim.extraPackages so the
  # same binaries are reachable from the shell, not only from nvim's wrapper.
  home.packages = [ nvim-scratch ] ++ (with pkgs; [
    git
